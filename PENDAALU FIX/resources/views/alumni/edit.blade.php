                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            value="{{$alumni->no_induk ?? old('no_induk')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            value="{{$alumni->no_ijazah ?? old('no_ijazah')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            value="{{$alumni->no_skhun ?? old('no_skhun')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            value="{{$alumni->tahun_lulus ?? old('tahun_lulus')}}">
                                            ...
                                            value="{{$alumni->tgl_pengambilan ?? old('tgl_pengambilan')}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            value="{{$alumni->nama_sekolah_lanjutan ?? old('nama_sekolah_lanjutan')}}">
